		...
		var eventClass = {
			...
			_vOptFChkArr : {"v240":"", "v336":"", "v480":"", "v720":"", "v1080":"", "v2160":""},
			vOptArr : {"v240":"", "v336":"", "v480":"", "v720":"", "v1080":"", "v2160":""},
			_conType : "video",
			_fullCheckF : true,
			_adKind : null,
					...
					if( eventClass._vOptF ) {
						...
						switch( e.target.id ) {
							...
							case "vO720" : 
								...
								break;
							case "v1080" : 
								eventClass.vObj.src = eventClass.vOptArr.v1080;
								jQuery(document.getElementById("video_player")).find("source")[0].src = eventClass.vOptArr.v1080;
								videoObj.load();
								eventClass.vPlay();
								jQuery(".clsBitTxt").html("1080P");
								oT = true;
								break;
							case "v2160" : 
								eventClass.vObj.src = eventClass.vOptArr.v2160;
								jQuery(document.getElementById("video_player")).find("source")[0].src = eventClass.vOptArr.v2160;
								videoObj.load();
								eventClass.vPlay();
								jQuery(".clsBitTxt").html("2160P");
								oT = true;
								break;
						}
						if( oT ) {
...
//							alert('재생중 오류가 발생 하였습니다.');
							document.getElementById(eventClass.vTargetDiv).innerHTML = "<font color=#fff>재생중 오류가 발생 하였습니다.</font>";//( agentClass.uAgent.match("MSIE") ) ? eventClass.playerIE("video_player") : eventClass.playerETC("video_player");
...
//				_playObj += "			<ul class=\"clsBitrateSel\" style=\"display:" + ( this._vOptF ? "block" : "none" ) + "\">";
				...
				_playObj += this.vOptArr.v2160 ? "<li id=\"v2160\"><em></em>2160P</li>" : "" ;
				_playObj += this.vOptArr.v1080 ? "<li id=\"v1080\"><em></em>1080P</li>" : "" ;
				_playObj += this.vOptArr.v720 ? "<li id=\"vO720\"><em></em>720P</li>" : "" ;
				_playObj += this.vOptArr.v480 ? "<li id=\"vO480\"><em></em>480P</li>" : "" ;
				_playObj += this.vOptArr.v336 && this.vOptArr.v1080 == "" ? "<li id=\"vO336\"><em></em>336P</li>" : "" ;
				_playObj += this.vOptArr.v240 && this.vOptArr.v2160 == "" ? "<li id=\"vO240\"><em></em>240P</li>" : "" ;
			...
			vPlay : function() {
				...
				if (eventClass.playTimeObj == "")
				{
					if ( this.vOptArr.v720 != "" ) {
						this._vOptFChk = true;
						$("#vO720").addClass("on");
					} else if (this.vOptArr.v2160 != "" && this._vOptFChk == false ) {
						this._vOptFChk = true;
						$("#v2160").addClass("on");
					} else if (this.vOptArr.v1080 != "" && this._vOptFChk == false ) {
						this._vOptFChk = true;
						$("#v1080").addClass("on");
