		...
		var eventClass = {
			...
			clicksFunc : function(e) {
				...
				try {
					switch ( e.target.className ){
						...
						case "play" : eventClass.vPlay();		break;
					...
					if( eventClass._vOptF ) {
						...
						switch( e.target.id ) {
							case "vO240" : 
								...
								eventClass.vObj.src = "index_files/20140408230429057y2xrad0hj03qq.mp4";								
								eventClass.vPlay();
								oT = true;
								break;
							case "vO336" : 
			...
			eventsFunc : function(e) {
				...
				console.log("eventClass._setAd = " + eventClass._setAd);
...
//							jQuery(".hdvdo, .app_down").show();
				...
				if( resAgent == "smart" ) {
					//try {
						...
						if(runCheck != undefined) {
							...
							var codes = {"mWindowID" : "pandora/app/", "mAppID" : "movie", "mCategory" : ""};
			...
			playerVideo : function(objName) {
				...
				if( this._conType == "audio" ) {
					...
					_playObjConType += "			<source src=\"index_files/20140408230429057y2xrad0hj03qq.mp4\" type=\"" + this.vType + "\">";				
					...
					if( navigator.userAgent.match(/iPhone/i) ) {	// IPhone 일 경우 Image 영역으로 교체
						...
						_playObjConType += "			<source src=\"index_files/20140408230429057y2xrad0hj03qq.mp4" + this.vType + "\">";				
			...
			vPlay : function() {
				console.log("Pandora vPlay START");
				console.log(eventClass.vObj);
