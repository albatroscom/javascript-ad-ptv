...
!function (name, context, definition) {
	...
	adptv.onPlay = function () {
		...
		jQuery("#big_play, .hdvdo, .video_down, .bar, .nx_btn_area, #Application_Div, .full_screen").hide();
...
//		_icfObj += "	<!-- <p class=\"btn_b02 btn_gf01\"><a href=\"#\">Gift</a></p> 각 버튼별로 이미지가 01~03까지 제작되어있습니다.-->";
		_icfObj += "	<p class=\"btn_skip\"><a>잠시 후에 광고<br /><strong>Skip &gt;&gt;</strong> 이 가능합니다.</a></p>";
